...
public class ConnectionPool {
    ...
    public void  initPoolData() throws ConnectionPoolException {
        ...
        try {
            ...
            throw new ConnectionPoolException("SQLException in PoolConnection", e);
        }
    }
    ...
    public void closeConnection(Connection cn, Statement st, ResultSet rs){
        try {
            cn.close();
        } catch (SQLException e) {
            e.printStackTrace();
    ...
    public void closeConnection(Connection cn, Statement st){
        try {
            cn.close();
        } catch (SQLException e) {
            e.printStackTrace();
    ...
    private class PooledConnection implements Connection{
        ...
        public PooledConnection(Connection cn) throws SQLException {
            this.connection=cn;
